# [iSulad+Kuasar：管理面资源消耗锐减 99%的新一代统一容器运行时解决方案](https://mp.weixin.qq.com/s/vQFMprINh9jMiKRJwGOX0g)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMaeQsfOgZjHRmBYnibTaGlfccick8R0tZrK9Zvzpna5m1WUc6wbibhcsydlvRu6asnhnFNSmlKE6bgiaQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMaeQsfOgZjHRmBYnibTaGlfcXuJA75G2wgvJFhaXMUCUJ8ZdZOYPocJqoiadsr0eqibCEic5krSHdpoxA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMaeQsfOgZjHRmBYnibTaGlfcgYlv9pyYMzEyGnAy92Z0wMgZshTXGODGiceZTIialr3Cs9bt0OcqQiaVg/640?wx_fmt=png)
...
1. **「Sandbox 的语义被带入了容器引擎和容器运行时」**，在语义层面与 CRI 保持一致，增强了在云原生架构上的连贯性。
2. Kuasar 用一个 Sandboxer 进程取代了 shim v2 中的多个 shim 进程，解决了由 shim 进程带来的多个问题：
...
3. 在新的架构中，Pod 是通过 Sandbox API 创建，不必遵循 OCI 标准流程，从而**「消除了 Pause 容器的冗余」**。
4. 新的解决方案**「支持在单一节点上通过配置运行多种不同类型的沙箱，利用不同的隔离技术，在性能、安全性及通用性等各方面形成优势互补」**。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMaeQsfOgZjHRmBYnibTaGlfcq2tI5JE34K8ArpiarjXYklS0mMB5zAV5XdffrGvc3Msn4tBQ0WJJlOg/640?wx_fmt=png)
...
容器引擎项目 iSulad: https://gitee.com/openeuler/iSulad

\[2]

Kuasar: https://github.com/kuasar-io
...
dev-sandbox 分支: https://gitee.com/openeuler/iSulad/tree/dev-sandbox

\[5]

用户指南: https://gitee.com/openeuler/iSulad/blob/dev-sandbox/docs/manual/sandbox\_zh.md
