# [「转」把集群变“单机”（下）——openYuanrong核心架构设计解析](https://mp.weixin.qq.com/s/a-B7waZG6LvjEiFnEHUniw)

*梁义*[OpenAtom openEuler](javascript:void%280%29;)*2026-01-30 18:00:00中国香港*

## **背景**

## 面向云原生和AI给分布式计算带来的全新挑战和机遇，openYuanrong 提出分布式内核的技术理念，希望将集群变成一个大“单机”，让分布式应用的开发运维像单机程序一样简单，同时为应用和集群带来高性能、高资源利用率和高可用等收益。

为设计实现这样的分布式内核， openYuanrong 提出函数、状态、数据对象、数据流等几个核心概念，灵活表达各类分布式应用。

关于 openYuanrong 分布式内核理念及以上几个概念抽象的详细介绍，详见上一篇文章：[把集群变“单机”（上）——openYuanrong核心技术理念解析](https://mp.weixin.qq.com/s?__biz=MzkyMjYzNjU0Ng%3D%3D&mid=2247518366&idx=2&sn=8afe885d792c4bbf056816a0b151e522&scene=21#wechat_redirect)。

## openYuanrong 整体架构

![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXiaX1oicypPpQ3pwGYLPzibgmfqd5YW2mSPgNLLsezBPhdMoUlO0YMStmpg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXiaq4E2fZNhlictibZIYqf5PZyAuNiafkEEicSwGNpgENSGdRM7ymeaZOSvZw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXiaFF6O7HriaOgNFdErQXvfvtfymTURekuXouLvxXc7mQicVtoq4W6oaN0Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXia9lv2r9ZnPoIjzKhF8rx0msVySqlglass1Eo7aKc8E2vYYxMk9VO0PQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXiaqhSZGDaJKf8CesfjoQjHlcUsru3HFZjUTf7kvRaQ0Qm28TX6VNk31A/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqhL3mqFmwdiaGm192hKJfXiaExq9dMtMt5dS8m09NFrKVdts8lYtjozMefrFDRpwR2qicoHE4iavhpfw/640?wx_fmt=png&from=appmsg)
...
openYuanrong Serverless 分布式计算引擎致力于通过分布式内核技术理念，将大规模分布式集群变成一个大“单机”，提供单机体验编程简化分布式应用开发，通过大规模动态弹性调度和分布式内存数据共享支持各类分布式负载在一个大集群内统一高效运行。

基于openYuanrong，AI、大数据、微服务等各类不同分布式场景应用既可以简化开发运维，也可通过统一的分布式技术底座实现高效协作以及资源的充分共享和复用。

* * *

\[1] 官网地址：

https://pages.openeuler.openatom.cn/openyuanrong/docs/zh-cn/latest/index.html 

\[2] 源码地址：

https://atomgit.com/openeuler/community/tree/master/sig/sig-YuanRong

\[3] 问题反馈：

https://gitcode.com/openeuler/yuanrong/issues
