# [openEuler 资源利用率提升之道 03：rubik 混部引擎简介](https://mp.weixin.qq.com/s/c0vNyJXThbV8qCWoFq8u0A)

[OpenAtom openEuler](javascript:void%280%29;)*2022-08-29 22:30:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KMVC9BSXbUc8Eicfniaqkn3XPic1K0FibXCgmZT200lsF4Ye7fLwe1HkD1A/640?wx_fmt=png)**rubik混部引擎在系统中的位置**
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KBpvbTb4En2oq4yXz5KB3vJxC3QQwAzsUiaXPeZMf0FXgK7GcpianY3Yg/640?wx_fmt=png)**rubik 混部引擎特性**
...
> 2. yaml 中主要包含 ClusterRole、ClusterRoleBinding、ConfigMap、DaemonSet 四部分。其中 rubik 的启动配置参数包含在 ConfigMap 里，详细的配置说明可以参考rubik 配置说明（https://gitee.com/openeuler/rubik/blob/master/docs/config.md）
> 
> ?
...
最后，查找并进入`nginx-online` Pod 对应的 cgroup 下，查看`cpu.qos_level`是否生效（在线业务为 0，离线业务为-1），具体运行效果可以查阅典型应用下的效果中案例 1\[2]：
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9Kny5xQib4T5bMib2ibnwqV9pPn08V1HaNwbOZut7IW1xOO7ic6pUycsyntA/640?wx_fmt=jpeg)

## 系列文章回顾

\[1][openeuler 资源利用率提升之道 01 ：概论](https://mp.weixin.qq.com/s?__biz=MzI2NDE4OTE2Mg%3D%3D&mid=2247493405&idx=1&sn=47bb21482f87619e6a82213e20b3120f&scene=21#wechat_redirect)

\[2][openeuler 资源利用率提升之道 02 ：典型应用下的效果](https://mp.weixin.qq.com/s?__biz=MzI2NDE4OTE2Mg%3D%3D&mid=2247495261&idx=2&sn=684228e8ebef621cf62e0e2999e98c9f&scene=21#wechat_redirect)
