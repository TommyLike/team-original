# [活动回顾｜openEuler sig-Long 异构融合技术 Meetup 北京站](https://mp.weixin.qq.com/s/1_n11h6DZDtb7770CoW6Pw)

[OpenAtom openEuler](javascript:void%280%29;)*2025-08-26 19:51:00广东*
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPquD9oPUreoAyO23icnJZ7LDdibWa1G9h7PE3NqVN5HiaiaALFw6SrpT3ibA/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPaNT4E4iaRo6Kjln1Cr1iaqz7ibBDCd3vrhFqeibeoicGZvw7MlGsTPS1bOQ/640?wx_fmt=jpeg)

**02**

大模型训练运行时快速轻量故障恢复技术研究
...
![](https://mmbiz.qpic.cn/mmbiz_png/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPb3hnFA2dJibPBknKHHauKpaPdCRAtul1WEMxdR0ibVZLKF4fsqQCfqjw/640?wx_fmt=png)

**03**

sig-Long 社区技术介绍与进展

为了向社区成员更加清楚地展示sig-Long社区情况，openEuler sig-Long 的 maintainer郑弦首先介绍了sig-Long成立的基本信息，包括技术背景、目标及名字的由来, 随后介绍自sig成立以来sig-Long的项目情况，例如全栈开源大模型推理解决方案llm\_soluton、针对AI负载加速的高性能分布式文件系统FalconFS、面向MoE架构的系统推理引擎Expert Kit等。最后展望了对sig后期的项目情况，将计划围绕易用性与Agent开源3个项目。

![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYP9GKjw6BeRYMP5ibHAOLejtR0e6IoqMbiaultFJk69tethYUSAznAHHlA/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYP4TVSia1gec2aJHvibic1AsIjnzHJa0sXQwYKKVBvxZQjTwmFtvc7TnI2g/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPScWiaI2GvFrD6pCBNcUYpEsknMS6K4IdPTI2SOdvhvsyj0G09mAovaQ/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPeBhbCgRuZ2WlebRPzqLPzgwdKbsTOR4pJmKDxLvMEc1SBU9DhFxFgw/640?wx_fmt=jpeg)

**07**

CXL在英特尔至强处理器平台上的创新应用
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mD8HfcP8PPBpwAnWaLgPMYPWGXMOibcnxib1259xyMNw7A0NdwEzVu0qYzwaibvJtqKRiaN74DB6xyUpA/640?wx_fmt=jpeg)

演讲 PPT 下载

本次 Meetup 的分享材料已上传至 openEuler Gitee 仓库。如果您需要本次活动的PDF，可前往下方链接获取，期待您的下次参与！

https://gitee.com/openeuler/presentations/tree/master/meetup

本次Meetup的直播回放已上传至B站openEuler官方账号。如果您错过了本次线下活动，可前往B站回看。

https://www.bilibili.com/video/BV1s6exzDEhL
