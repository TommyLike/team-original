# [safeguard—基于 KRSI (eBPF+LSM)的 Linux 安全防护系统](https://mp.weixin.qq.com/s/R8VY00drih9mSL-RA7DlQA)

[OpenAtom openEuler](javascript:void%280%29;)*2023-11-07 17:30:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbn65nYwXVibMPq745KWr16ZLRQuandtiaGgShGrR4YGnNc60YkwI22JnlT39CRtbTv4m7snPibam67Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbn65nYwXVibMPq745KWr16Zib1O3SrxGapLCGdWRWMjyVpsPMfiboelM1E5hUsPsvPIcXM9CH7fLjrg/640?wx_fmt=png&from=appmsg)
...
①拦截或重定向文件（比如密钥文件、用户账号文件或需要安全防护的各种类型文件等）操作，使用eBPF来拦截对敏感文件的读写操作，或者重定向对某些文件的访问到其他位置。
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbn65nYwXVibMPq745KWr16Z3Ol2Lv0hUo1h6ibSvmxV6cM20SlQAN8ia87CQwuh7xt8v0fyhWNTMfQA/640?wx_fmt=png&from=appmsg)
