# [【openEuler创新项目探索】一个Java端的向量化BLAS库VectorBLAS](https://mp.weixin.qq.com/s/sKitQiY3q26bXHVmJvMZOA)

[OpenAtom openEuler](javascript:void%280%29;)*2023-08-14 20:00:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbsfCaUj2SgicvxyxS4SvWDY15thibNQgZZZSrgUVgictHaNFqwzx2ylVejAc2RDib3rNicqtbN8DFw7dA/640?wx_fmt=png)
...
矩阵分块是一种cache优化手段，当数组、矩阵的规模较大的时候，在N层循环中的跨度太大时，无法\`fit in the cache\`，数据则会被清出了缓存，造成较高的\`cache miss\`率；

通过矩阵分块，可以将小块数据锁在L1/L2 Cache中，提高cache命中，降低\`cache miss\`率。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbsfCaUj2SgicvxyxS4SvWDYIFkcYjTKf3GWHqrdEBzuNPHQrZrfkCqfRKygudhwd7jsyA5um7XRdQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbsfCaUj2SgicvxyxS4SvWDY8qbbn0WnxmjgKDQibNpfFlDib2MiatcbbOZpvHHKoMViaPBEbSQSNCF9hg/640?wx_fmt=png)

**性能数据**

现有版本基于鲲鹏服务器测试验证，性能相较于业界同类库F2jBLAS/ludovic.netlib都有提升，如下图所示：

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbsfCaUj2SgicvxyxS4SvWDY6CaQBdYmNtWRjspLPdqcPdpB1r1Ng3H6Z7nHnaVHVmxYeeMRrUTlrg/640?wx_fmt=png)
...
[阅读原文](https://gitee.com/openeuler/vectorBlas)
