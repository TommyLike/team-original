...
原创*SIG-CloudNative*[OpenAtom openEuler](javascript:void%280%29;)*2026-06-27 16:23:14广东*
...
OpenAtom openEuler（简称 “openEuler” 或 “开源欧拉”）推出的 Conch 正是针对这一场景设计的沙箱引擎。在上一篇文章[《openEuler Conch](https://mp.weixin.qq.com/s?__biz=MzkyMjYzNjU0Ng%3D%3D&mid=2247519039&idx=1&sn=d215c85c189f3ceb62f3714798be16ac&scene=21#wechat_redirect)[沙箱引擎：如何用毫秒级速度给“闯祸”的小龙虾套上“海螺”壳](https://mp.weixin.qq.com/s?__biz=MzkyMjYzNjU0Ng%3D%3D&mid=2247519039&idx=1&sn=d215c85c189f3ceb62f3714798be16ac&scene=21#wechat_redirect)[》](https://mp.weixin.qq.com/s?__biz=MzkyMjYzNjU0Ng%3D%3D&mid=2247519039&idx=1&sn=d215c85c189f3ceb62f3714798be16ac&scene=21#wechat_redirect)已针对 Conch 进行了详细介绍。本文将深入其背后的架构设计，围绕以下核心问题展开介绍：
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOs3ibDsmIUetic1aRNNCMGFaoVGNn4ZxnUnbBD13E762vQV8CTEZkRbej3J6uFCPyrwRjUXTia8tUZWIia8VYjWlfy530EjhWfxM5o/640?wx_fmt=png&from=appmsg)
...
为适配完整沙箱的定义，Conch 在架构上定义**两个核心对象：**
...
应用 rootfs 与 layer 元数据

应用内容标准化分发

sandbox-image

把已有 rootfs 变成可启动沙箱镜像
...
需要在稳定时机 pause 并导出，不能代替所有运行时调度能力

![](https://mmbiz.qpic.cn/sz_mmbiz_png/rxr9tddEHOuXfsSaE5FLT15SSAzC1NYoskrbxqICQ0UXmIKAUUuMnnVKLy0XqTl7H6JCibExSKlicQoPhEtJ6MWe59B1pkV7PBqDKicGJlVRfw/640?wx_fmt=png&from=appmsg)  
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOsPXEJghlYe0cPNV1hZ1q220rjmKa6JibbqRf8fGxn8XvDIsby9EvfbUQwlnwZOSevpIeibIsqSBjcgzibLnibkg02p54Ne0iaicDOicU/640?wx_fmt=png&from=appmsg)  
图3：Conch镜像工作流总览图
...
**4.3 打快照时机 与 sandbox-snapshot 制作**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/rxr9tddEHOsyP70ZrmKgTsPxKe1gSAh8u85u9d4yuxIlerhcic7uVxHmSRAdTicoTcgfFTJlwfiakbnSjp1Gg3JFAsyIkwon0Xo1GGsTMv59Xs/640?wx_fmt=gif&from=appmsg)  
...
![](https://mmbiz.qpic.cn/mmbiz_gif/rxr9tddEHOvpu2iaoKd3XXMswSsPCM3AEjFicLHJgBRpicZicvB9XDFOrFScIomm4C8GKHic1E0ib0SZnzXLw6dL7M7PwGjS7YAWhneFzzicEge79o/640?wx_fmt=gif&from=appmsg)

# **欢迎加入社区共建**

Conch 已在 openEuler SIG-CloudNative 社区
...
进 SIG-CloudNative 技术交流群

也可访问 AtomGit 仓库查阅完整项目材料
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_jpg/rxr9tddEHOtCiady7p99sffbmibttmU43dUAaGG7Y2XeEIiaWBcy7hwJ5GNN8GgDRQVOaice9Hna82EOSEmrjaUOGtbV5Akgzj83JPcpaO4QyEk/640?wx_fmt=jpeg&from=appmsg&wxfrom=5&wx_lazy=1#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/jqTxnpIZ2mCbBSyvm2AJRXb5x9C3DgH2d1CvxNf56DXribfOKnOqvMU1jP4fVRpO45sDy84Knibcp1OuASLm5MMg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1#imgIndex=10)
