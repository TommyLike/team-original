# [SysCare：为您的操作系统保驾护航](https://mp.weixin.qq.com/s/oTCpj7TjDXf2TtPpCjB08A)

[OpenAtom openEuler](javascript:void%280%29;)*2023-04-25 19:45:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQvDqTWEiaibgljER7nJul4TBLhPahoKq0iaB4trnxvybM9iclaia0AAppJjRg/640?wx_fmt=png)
...
通过对比修改前后的代码生成的.o 目标文件的不同，找到差异点，将差异点取出，生成热补丁。如下图所示：分别编译修改前后的代码，比较生成的 .o 文件 ( source file 和 after patched )，找到变化的部分：新增 (data\_e, func\_6)，修改 ( func\_4, func\_3 )，删除 ( data\_b, data\_d, func\_2 ) 的部分，将这些差一点提取到一个 .o 文件中 ( real patch ) 。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQvIiaMhtJpRNy8OoNtK2khelgvurrcbkQvQTth71z6ndGlJLfIia2WibO0A/640?wx_fmt=png)

**「劫持编译器，跟踪编译过程」**

通过 uprobe 技术，向 GCC 等编译器注入代码，跟踪程序的整个编译过程，在编译过程中获取制作热补丁所需的信息和 .o 目标文件。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQvug4cceAafu3mRZr2Ds0sPlsoH85iajSSP3zibeFWUJloFGFLh1SBiagsg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQv0pDDWAp4c3JMTtOUZXggR4ghR5TrXVSwYh5QxSOPaozUuvE1lhXbGA/640?wx_fmt=png)

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQvw09Obauh1erBMYvnOPHq7coRREW0HxPmKkVF6qlHf1xT08zWX8T17A/640?wx_fmt=png)
...
具体使用方法可参见官网文档：https://docs.openeuler.org/zh/docs/22.03\_LTS\_SP1/docs/SysCare/使用SysCare.html

此处，也给出了 SysCare 的实际应用 demo 演示视频：
...
如果您对热补丁技术感兴趣，欢迎加入我们。您可以添加如下小助手微信，回复 SysCare 加入交流群。

![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMbseXXSK1JIYAQHMicCiaLLQvRibRqIK3Q0X17W1cCcXL7GlTTN0wpVLhTPuUghBibWGJnSVCIlr1hwvw/640?wx_fmt=jpeg)
