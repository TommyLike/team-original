# [OpenAtom开源项目Cloud HPC选择openEuler作为默认操作系统](https://mp.weixin.qq.com/s/mW2CXEwsYlNFnBYMqxUzKA)

[OpenAtom openEuler](javascript:void%280%29;)*2023-10-20 18:30:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZicVBicSVRicCgwqkOMMN4slbkkSfcdiafCA31cibk8nY7oVJoswNpgATAgSIkxlJgmdTy5yeOybAjiajQ/640?wx_fmt=png)

图1 腾讯云创建实例时直接从镜像市场获取openEuler

如果用户选择通过方式2导入私有镜像到云平台，推荐使用openEuler社区工具链[EulerPublisher](http://mp.weixin.qq.com/s?__biz=MzI2NDE4OTE2Mg%3D%3D&mid=2247507347&idx=2&sn=6851d860f59e4809223ac1df5041863f&chksm=eab2f816ddc5710089399a51e81b02362a7d2d62e402659c586f17dd5ba9367049fa8d4e3f91&scene=21#wechat_redirect)\[2]定制openEuler云镜像，它可以根据用户需求灵活预置软件，适应多种场景。此外，OpenStack社区的diskimage-builder\[3]自2022年起已原生支持构建openEuler镜像，也可作为一种用来制作私有镜像的选择。
...
2\. 集群创建完成后，用户可以通过 hpcopr rdp -u USER\_NAME --copypass 直连至集群的图形化桌面环境。openEuler 的桌面环境已经在集群创建过程中自动化完成部署和安装，用户无需手动安装。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZicVBicSVRicCgwqkOMMN4slbJWtVe3krRY4KvTXgESibcmUwpF5tw3wUeuHDbIqVmGQ3btyCNurYh2A/640?wx_fmt=png)

图2 AWS上一键拉起openEuler集群

**openEuler集群运行**

![](https://mmbiz.qpic.cn/mmbiz_svg/9UjCmequjU9IGzh0taSCQCGeG2DGU1fS5TAm6XeU1ibSOzUG7LrUFRf1SYtIzDOJ1zjsga4nFoh8nFkbMmnj8d7Z2Rq4oEHrC/640?wx_fmt=svg)

**基础功能**

按照上述步骤拉起openEuler集群后，即可运行作业任务。目前Cloud HPC作业任务已完美运行在openEuler集群上。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZicVBicSVRicCgwqkOMMN4slbibuvLF6uFa808AehfxVsTLaxT5YgD9nwKic8SbQSCl1H92wHibX39gI0Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZicVBicSVRicCgwqkOMMN4slbopS8gJLEgbjfSsVYncO8YMMRFAubxXCvtqcv6XSqQBfXYAnssGiah1Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZicVBicSVRicCgwqkOMMN4slbqo78ibvpvt7prs3Db0Zic53tMQNALtRMusQdxcDicF90UicyibAHNnsGsmA/640?wx_fmt=png)
