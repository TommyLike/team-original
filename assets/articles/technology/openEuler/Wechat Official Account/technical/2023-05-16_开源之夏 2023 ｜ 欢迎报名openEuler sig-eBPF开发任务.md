# [开源之夏 2023 ｜ 欢迎报名openEuler sig-eBPF开发任务](https://mp.weixin.qq.com/s/UXpVqgPcoaXI9qik3SXdBQ)
...
今天给大家带来sig-eBPF的任务介绍，可编程内核在Linux系统里的重要性不用多说，sig-eBPF 本次发布了6个可编程内核方向的项目任务。
