# [活动回顾 ｜ openEuler AI 与操作系统融合创新 Meetup 北京站圆满举办！](https://mp.weixin.qq.com/s/5OtgMdLVeYAHEYbvM1T2ng)

[OpenAtom openEuler](javascript:void%280%29;)*2026-06-05 17:57:09中国香港*
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOtlm8LArtod50y6jlo9JOY0uoR0Daf4djpkT5klvCo9b98oibWdUaqSV8GyialicpXLyDt1CWcZqibvb936cVl5zicgO67SbMpNgtL4/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/rxr9tddEHOssaT69z7wx77ickO2Ohfme1lDCDI1022rXLcq7bsWeHVfDVPx6hia6yHIIqweXiciazxOFMfre1CZrBXSqZjym7Aor1KEmLWy2YVM/640?wx_fmt=png&from=appmsg)

**01**

**基于sched-ext的调度策略管理框架**

联通数科操作系统研发工程师余昇锦分享了基于sched-ext的调度策略管理框架。目前Linux sched-ext 可扩展调度框架已正式合入内核，为调度策略快速迭代奠定基础，但仍面临策略分散难复用、实验方案难工程化、生产运维门槛高等痛点。为此联通数科打造scx-loader调度策略管理框架，依托Policy-as-Process设计，实现策略热切换、故障隔离与自动恢复。配套搭建scx\_hub云端生态，提供策略托管、版本管理、签名核验与场景推荐能力。同时拓展sub-cgroup细粒度调度隔离，适配容器业务，并融入AI智能调度体系，通过观测、决策、执行全链路，实现调度策略智能推荐、参数调优与异常回退，助力服务器、桌面、容器场景实现调度能力标准化、工程化与智能化升级。

![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOtxicCS4aE1hQBLXRfiau2jULj3wnh3iaHOVPiaujRkO7Kx0IIwpcvYicWmaGODVkszbxcUuJTdQu1ozwwbaawvsjBGptOibYEibDkRDI/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/rxr9tddEHOslBmbHpgaE10p16Cib2R1VFdPn8QB2E2GmF68KJD33YjMJDxSEdFnRSz8fuR8SXRlQjvVWHib9twknIGpvJSFQQOTcYIF1cAqpY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOtnqeFjFRIPrFGGlmPgLLofnRtBpzEMKraLibedicHkmpXq93Axdib7o7Yjm0TGlCzlyBm2Fh8m6jCvWicwFWwxjZJE5S2lH2hh9Gg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/rxr9tddEHOsAibfyOuuWKYAY72w2fyZkKkYOk5XUKxrVNN0APNaZibdYCdwuSJ3kcqf4wFpmsIHA4OWWcaic9FOzgTvC1sMUB965LpAcxQJFcY/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOvfjKRmPOPjRAmUU4NqP21ZOu8coRGu7wxmxkq5B5HicGwLddrP6S1jLllMngUQ4cOnReRrUf5LSuc9oqddBsqJiamATQ7vtuvIk/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/rxr9tddEHOsKiapz5ty1aWAoVmzCJXvrOJicxZloQhjfgKDgibNR1NfSicic6kbGUshncQXGpZDfUKpEibJ7LibpicI8JcrBOwfcVNib5GEdaUMsMdib8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/rxr9tddEHOsib9hjw9ylFGwokrsmhFbs8rGXRkOQIQHibJVKppvA0jWUC2fvvZbxuxs76VKRLiapjlxLpxG3tAXb8pBbNibzcgVNppOiaFoLp83Q/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/rxr9tddEHOsTibBthB64YadIj1jXhu8cWdYf9FIuTAGdhbmdS9tQL8qqIia9jz7iaA1B9UVVkCMnBBMtv7iasxicTKP0SSbtuC7nx3fsRibibvHbmE/640?wx_fmt=gif&from=appmsg)
