# [「转」在openEuler环境下快速编译GreatSQL RPM包](https://mp.weixin.qq.com/s/LAFG-iTk8Eg_h5jcazSicw)

*YeJinrong/叶金荣*[OpenAtom openEuler](javascript:void%280%29;)*2024-01-26 21:40:55*
...
运行环境是docker中的openEuler 22.03 x86\_64：
...
编译GreatSQL 8.0.32-25版本需要配套的boost版本是1.77，访问此链接下载 https://boostorg.jfrog.io/artifactory/main/release/1.77.0/source/boost\_1\_77\_0.tar.gz，放在上面创建的 `/root/rpmbuild/SOURCES` 目录下。
