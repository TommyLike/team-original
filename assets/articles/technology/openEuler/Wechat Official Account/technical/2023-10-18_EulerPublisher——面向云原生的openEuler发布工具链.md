# [EulerPublisher——面向云原生的openEuler发布工具链](https://mp.weixin.qq.com/s/vR0Sl7oY-sVDPM54vGuEfg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZ0KJEAFVmvd6M1DOlM3dpDETI9z17551ZokXRvZtSDgCWlWygK5oaFXBYEv24LNZ0zfhrnYRdDGQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMZ0KJEAFVmvd6M1DOlM3dpDqibaxzMGndgI6pDGlAOFWnXgibkO8F3JZ5EiaLauS8lnMF87vxNOLdm4g/640?wx_fmt=png)

执行多仓库发布命令之前需要预先配置好每个registry的登录用户名和密码环境变量，如LOGIN\_DOCKER\_USER和LOGIN\_DOCKER\_PASSWD等。
...
此命令{VERSION}是构建目标镜像的openEuler版本号，{ARCH}指定构建镜像的架构类型，支持aarch64或x86\_86。这一步下载openEuler社区发布的镜像并解压，获得基础镜像。
...
\[4] AWS Marketplace发布openEuler镜像：https://aws.amazon.com/marketplace/pp/prodview-cgu5xymg7qnqg?sr=0-4&ref\_=beagle&applicationId=AWSMPContessa
