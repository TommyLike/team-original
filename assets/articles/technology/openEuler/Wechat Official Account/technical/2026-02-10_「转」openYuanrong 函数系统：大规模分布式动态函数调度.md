# [「转」openYuanrong 函数系统：大规模分布式动态函数调度](https://mp.weixin.qq.com/s/JdzpPHkDD1kMQC2Ec9NnhA)

*罗站城*[OpenAtom openEuler](javascript:void%280%29;)*2026-02-10 17:57:00中国香港*
...
关于 openYuanrong 的整体架构和设计理念，详见上一篇文章：[把集群变“单机”（下）——openYuanrong核心架构设计解析](https://mp.weixin.qq.com/s?__biz=MzkyMjYzNjU0Ng%3D%3D&mid=2247518460&idx=1&sn=7f3f3f6978b4ffe81bf35e25d6e0ef28&scene=21#wechat_redirect)

## 函数系统整体架构

![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1tYkQmGt5vQQ2sMEucdySWbGIUM3EWqFlxbU6S4G5ZJCtVZqUBzKDcA/640?wx_fmt=png&from=appmsg)
...
- 分布式容错：支持故障自动检测，以及在故障情形下重拉实例，并恢复其最近备份的状态，同时支持函数调用过程中的分布式异常处理。
...
- 原生函数编程例子：
  ...
  ![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1hB4rnyKib8Q0GlxxpERwsjIaj9CoEvzCicEVU7fUruzFImYjDomjEmmg/640?wx_fmt=png&from=appmsg)
- 通过少量修改自动分布式并行有两种典型的场景：无状态和有状态。
  
  - 无状态编程的例子：
    
    ![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1qMXGKTLLVEAD4l5lnTy8FLeqD4uFn3Cg34XhWQNeuIkNBxzYlicQlnQ/640?wx_fmt=png&from=appmsg)
  - 有状态编程的例子：
    
    ![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1L2wtY8tFRBxmOibJTSrhk2VkIsETelracUACUF0EaQTdVkibCveVrhmQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1Nm5907msPZYHPNOeEvBWCm7vRFHahhtFcJ0swQAUVxb1GrHdzLMWAA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1OEgmgOAV34R3ZvZYvzsy3ibkpV86KPwLrSwMibJOSwQs8X2icYdqO0xwg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g13EQF8KPAvB2IfBCItFYEYdaH9R4tt9qNb3ypAbusYUcibFIYaS5N26w/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1uBu9ibQVjVQtYGOdvBicW5PJoJPlCCueD9iac823MpoqMkx3ElIElMKmA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1PF407FHc1HzsNExlekZHV8lTXulHicPQjVh5v862zd8DR6IzyT2DCew/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1u1OhykKY0uqp8gtkJiaIib4lNxQmreicDrQIutAmbZIoUH4ickINuozb3Q/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1VulLTn5rfS9MBmaviaOibYWAqoibOMq6D0fXhaicMHh6zn1cInNJy5y1QA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1Z8IuCeDprzW8dO2srvEOicaPTyibGqhbKuHc1MDsqibYe4aVLAnGqShUQ/640?wx_fmt=png&from=appmsg)

利用 openYuanrong 的编程接口，实现单机编程体验，快速支撑该工具万核并行，实现7倍加速。

![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g1NJf67gTriaRwtMgpnibBGJobortTjicicBV3AWc7SyD5rVBsqetziaHp4kA/640?wx_fmt=png&from=appmsg)

### 案例二

选取一个微服务场景，100个虚拟机（16C-32G）规模的集群，基于生产环境流量和业务负载回放测试，openYuanrong 的垂直弹性加动态调度可提升集群利用率至60.5% ，函数请求响应P95延时劣化&lt;10%，仍满足用户SLO。

![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvloVGpiavtTvRbibaX8RyGN0g10gj2ibTv34AEuKQ6x4d2QA9uuuLfafQOebG91VSYEKeXFcdas4pRqUQ/640?wx_fmt=png&from=appmsg)
...
\[1] 官网地址：https://pages.openeuler.openatom.cn/openyuanrong/docs/zh-cn/latest/index.html

\[2] 源码地址：https://www.openeuler.org/zh/projects/yuanrong/

\[3] 问题反馈：https://gitcode.com/openeuler/yuanrong/issues

欢迎添加 openYuanrong 小助手微信，由小助手拉您进我们的官方群获得最新资讯~

![](https://mmbiz.qpic.cn/mmbiz_png/lzCickRegvlqKvqW3U8ThYvnhaMKojFpH2RiaVa22AnmkCaep578iaxJIuDY7CuibxAAwBNN2jyoolmZN5B0OygTiaA/640?wx_fmt=png&from=appmsg)
