# [StratoVirt 的 vCPU 拓扑（SMP）](https://mp.weixin.qq.com/s/U5d8WWnvelF1FO5D6uOaCQ)

*黄文禹*[OpenAtom openEuler](javascript:void%280%29;)*2022-08-27 19:00:00*
...
Initial EAX ValueInformation Provided about the Processor0BHEAX Bits 04 - 00: Number of bits to shift right on x2APIC ID to get a unique topology ID of the next level type\*. All logical processors with the same next level ID share current level. Bits 31 - 05: Reserved. EBX Bits 15 - 00: Number of logical processors at this level type. The number reflects configuration as shipped by Intel. Bits 31- 16: Reserved. ECX Bits 07 - 00: Level number. Same value in ECX input. Bits 15 - 08: Level type. Bits 31 - 16: Reserved. EDX Bits 31- 00: x2APIC ID the current logical processor.1FHEAX Bits 04 - 00: Number of bits to shift right on x2APIC ID to get a unique topology ID of the next level type\*. All logical processors with the same next level ID share current level. Bits 31 - 05: Reserved. EBX Bits 15 - 00: Number of logical processors at this level type. The number reflects configuration as shipped by Intel. Bits 31- 16: Reserved. ECX Bits 07 - 00: Level number. Same value in ECX input. Bits 15 - 08: Level type. Bits 31 - 16: Reserved. EDX Bits 31- 00: x2APIC ID the current logical processor
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KfrsiblqpUAyOe1UhHicqpu19th0icsFJhWJibGibDaeiariaR21APEBkh3Jxw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KJneiat6at1QibARpTlFYVhqHGxN4HCygmG2ibtBSJq38qK2mKBtOtAoOg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KPBCwlGwkjHsIibBiciayjP1ib2UpNxYaicjndKqGCnDYs34BrqN2j6070hQ/640?wx_fmt=png)

参考：https://uefi.org/specs/ACPI/6.4/05\_ACPI\_Software\_Programming\_Model/ACPI\_Software\_Programming\_Model.html#processor-properties-topology-table-pptt
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KMHSnYoN6YR11sLHgQvPIjtvupZ3ux6r4TR56l2RD3um6VWvIFTsBEw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMa5icdlOsECBh1yK0ABWpv9KOf5MDehpFD7IqkzXtLA7dNiaVChk0wfdibfsafq7gAdug3LCOUHJic3mg/640?wx_fmt=jpeg)
