# [A-Ops性能火焰图——适用于云原生的全栈持续性能监测工具](https://mp.weixin.qq.com/s/WXArJbiA2nF93VyKSU71bA)

[OpenAtom openEuler](javascript:void%280%29;)*2023-02-10 20:30:00*
...
（点击文末**阅读原文**，即可查看安装部署说明）

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMYQnfYlve1IaVQptP1yKNMlbBR1egIibrKMMQ3ibMH9EvW5Wf5ZsjmugiapaEwwXRYPQCxgmDPibUFrNg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMYQnfYlve1IaVQptP1yKNMl59MHxaWHw45tp4y7VnvCibCze9Epzm8TQLrY83vX7LrT80GkOu4jEUw/640?wx_fmt=png)
...
下图显示了一个实测生成的gala-ops cpu火焰图，以右侧的一个tomcat容器调用栈为例，从底层往顶层看调用关系：tomcat pod内包含一个container，containter中有一个pid为2434466的java进程，进程内cpu占用最多的是名为http-nio-8080-e的JVM线程，JVM调用了C库函数thread\_native\_entry，再往上进入了Java方法java.lang.Thread::run，然后经过一系列的Java方法调用，最终走到了ksys\_write系统调用，然后进入内核态函数。这样一个Java进程**从k8s层-&gt;OS层-&gt;JVM底层实现-&gt;Java方法-&gt;内核态函数**——完整的调用过程就可以通过gala-ops火焰图追溯到。

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMYQnfYlve1IaVQptP1yKNMl9lJk4IYT23K22opicl0ftKG1qZyUru6Cm7sicqH6zhMEJbt20YmCOR2g/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMYQnfYlve1IaVQptP1yKNMlKGUTcPMekcr82NPEABTxoasA1RlNb50AUd9KxjUKMrcOfPpEaHibGgQ/640?wx_fmt=png)

对比开关cpu火焰图探针对kafka写入MQ消息性能的影响：

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMYQnfYlve1IaVQptP1yKNMlFia02SD05sK1MPGFzUsqwNhvgy7MHj143iaYU4ssYd3iaPrmRpSkTqMRw/640?wx_fmt=png)
...
欢迎大家使用gala-ops火焰图，也欢迎大家交流和反馈意见，点击文章下方【阅读原文】，即可到openEuler论坛参与讨论！

* * *

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbkWvibmWaPucFbqkC3Y8UZxV9F5IaT6usyZkLLpo1syHh86ib5uefpGGf8WB7Hj9iaxEqJiaL2zAugZA/640?wx_fmt=png)

[阅读原文](https://forum.openeuler.org/t/topic/464)
