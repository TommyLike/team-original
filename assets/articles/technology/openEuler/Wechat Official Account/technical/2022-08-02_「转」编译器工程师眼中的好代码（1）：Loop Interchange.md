# [「转」编译器工程师眼中的好代码（1）：Loop Interchange](https://mp.weixin.qq.com/s/2Su3rWiAmVCcv0y1cFy14A)

*张瑞楠*[OpenAtom openEuler](javascript:void%280%29;)*2022-08-02 18:00:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvoYHzdluZ9W2eicLBAJf72YCdxicXxlRyxiaPreyThfpfWEtiaU3bwBhefA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvm1yTfSp0OJXXiaSlicsjzMwGf1aUgVeF4eHE5kibEibKPibOgoo761miaM1A/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvpVee59lliasGyztHykpc3KTDw7SGPnMapxUCZkybV47yoZl466h88Lw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwva3XzkY3ibjSdoWSoM4OVt0n4NnicAxVvkX8BTtQAAQicicwLEibKmoamWaQ/640?wx_fmt=png)

```
$ sudo perf stat -r 3 -e cache-misses,cache-references,L1-dcache-load-misses,L1-dcache-loads ./a.out
```

![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvyF2f4lS44YxCvUryr9MV7ia4zQBHkVia36icDDnicy32uJaT3qTv03V4ww/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvmMibicvDJicVe6wzOJVq1icNCyFp5pMyTzanPZ9G5VdSriaXHYnyvgAbjBg/640?wx_fmt=png)

```
$ sudo perf stat -r 3 -e cache-misses,cache-references,L1-dcache-load-misses,L1-dcache-loads ./a.out
```

![](https://mmbiz.qpic.cn/mmbiz_png/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwv4hNsy14K5dWd11Rnic3iacu0qbyAaGth7otUWLMvtnNKiaUqpGr2tXzxw/640?wx_fmt=png)
...
- D124725 \[NFC]\[LoopCacheAnalysis] Use stable\_sort() to avoid non-deterministic print output
...
\[4]https://en.wikipedia.org/wiki/Loop\_interchange  
...
\[8]https://en.wikipedia.org/wiki/Row-\_and\_column-major\_order  
\[9]https://en.wikipedia.org/wiki/Locality\_of\_reference

![](https://mmbiz.qpic.cn/mmbiz_gif/icntuIQtpSJVMOJNGmUIZU76C5BmU1nwvGkwolxicfs0fqjbjVdPGHqSicHDYm0olklYBwEpIuAoTc83l3LVzpSeg/640?wx_fmt=gif)
