# [「转」openYuanrong 快速入门](https://mp.weixin.qq.com/s/tzwHpxZrjXUX3nA5Ra2UjQ)

*雷十一*[OpenAtom openEuler](javascript:void%280%29;)*2026-03-11 18:47:59广东*
...
具体内容参考[把集群变“单机”（上）——openYuanrong核心技术理念解析](https://mp.weixin.qq.com/s?__biz=MzYzOTQyOTk4MQ%3D%3D&mid=2247483671&idx=1&sn=d9ea007b9d796782ad3d89d314f215fa&scene=21#wechat_redirect)。

## 安装 openYuanrong

openYuanrong 目前支持在 Linux x86\_64 及 aarch64 (ARM) 上安装。不同的开发环境安装依赖如下：
...
运行示例请参考如下链接： http://docs.openyuanrong.org/zh-cn/latest/multi\_language\_function\_programming\_interface-/examples/simple-function-template.html[#example]()-project-function-service。
