# [欧拉首次亮相全球顶级开源盛会 OSSEU2022，为开源软件的可持续发展构建开放透明的软件供应链](https://mp.weixin.qq.com/s/NRQec7YSbTn4VS97W1EdSg)

[OpenAtom openEuler](javascript:void%280%29;)*2022-09-19 23:30:00*
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMbia3ffIic6ibTdicAyGFAWicRH2lT99ibuLVsoicIciaam3h8ibiczzu73odVia5Y53p7icn1pjArfaYNBnwxkIQ/640?wx_fmt=jpeg)
...
欧拉作为支持多样性计算的操作系统，目前已经支持 ARM、X86、RISC-V、POWER、SW-64、LoongArch等全球主流芯片架构，并且取得了不错的进展，目前软件仓库中有ARM软件包超过**25000**个，X86软件包超过**16000**个，RISC-V软件包超过**23000**个，为成为最佳支持多样性计算的操作系统构建了丰富的软件生态。会议期间，**Linus** 表达了对ARM架构的喜爱，并表示ARM架构的芯片会在服务器和桌面操作系统方面大有作为。

![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMbia3ffIic6ibTdicAyGFAWicRH2qtYPd4FABnR0LZBwGibB5ElFrbCtyqWdx74gk6P1hCwIymlldhj5JuA/640?wx_fmt=jpeg)
...
**构建开放透明的软件供应链****是开源软件可持续发展的根本**

在大会开幕式环节，Linux 基金会执行董事 Jim Zemlin 认为开源目前在安全可信方面存在巨大挑战，需要大家携手应对。这与欧拉在开源安全可信上的做法不谋而合。

![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMbia3ffIic6ibTdicAyGFAWicRH2e10TIpNCNHfVHg3iaVD8oAF7ulrmSgKwDY9wnexBkUnIxrM8JvQmKMQ/640?wx_fmt=jpeg)

当操作系统出现漏洞时，开发者或用户如何实现分钟级的漏洞感知和漏洞溯源定位？面对这种情况，一个安全可信、公开透明的软件供应链显得尤为重要。

**![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMbia3ffIic6ibTdicAyGFAWicRH2ja8W9YoZJ0ib7DT9sc6DhJx3qIiciaqjXMVBbyTrHkCpE3YAodPjsKwpA/640?wx_fmt=png)**
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMbia3ffIic6ibTdicAyGFAWicRH2NbRadmmo3ZISkKWVmvu3ZZrJLy890r5rJCgOghxhVmvyZ6H8Dciafvg/640?wx_fmt=jpeg)
