# [Musl libc 库成功适配到 openEuler Embedded，推动欧拉嵌入式生态发展](https://mp.weixin.qq.com/s/NN3BKlzGN-jHgLjf-5P76A)

[OpenAtom openEuler](javascript:void%280%29;)*2023-05-26 22:30:00*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMb2z4NHo58To7cKYlyibIVr8o9fkO3DrC6NGDQibpib5KVuPfibTJhEdKwTFB7F7ibticeIg94RZazQGicrg/640?wx_fmt=png)

从上述测试输出结果可以得出以下结论：以 musl libc 为标准库编译的镜像在虚拟内存占用、物理内存占用、系统可回收内存方面都是远优于 glibc；

基于 musl libc 库的树莓派系统性能测试数据如下：

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMb2z4NHo58To7cKYlyibIVr8cpPm1dSicCI7IvfFCcibSgCDxcrjicYrmCWXoMnZk9NnTlUxtaictZY2Ew/640?wx_fmt=png)

基 glibc 库的树莓派系统性能测试数据如下：

![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMb2z4NHo58To7cKYlyibIVr8icpUvZ4PrOWjqU1NybEIoHx5PMcHYljV7SmBJt7ayicicItpxabv7EWVg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMb2z4NHo58To7cKYlyibIVr8GxsqMsB0mPzRcSW2YOo2P8nOibXkbYUJOPAZg651Y1DREwuO8qiatWtQ/640?wx_fmt=png)

**关于作者**

程智星，就职于南京软件技术研究院，操作系统组成员，负责 musl libc 库适配到 openEuler Embedded 系统，以及在性能和功能方面的进一步研究及日常维护等。
