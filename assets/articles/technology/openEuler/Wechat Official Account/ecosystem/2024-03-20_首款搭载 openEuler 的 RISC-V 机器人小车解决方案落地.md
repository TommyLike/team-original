# [首款搭载 openEuler 的 RISC-V 机器人小车解决方案落地](https://mp.weixin.qq.com/s/mFTn39WytYi-IsIHCkbwSg)

[OpenAtom openEuler](javascript:void%280%29;)*2024-03-20 19:31:00中国香港*

![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mDT1JzFPb3gsbShibjMoUfECWCGe9fQHib4JrjVicve6shdnuneJF1wpOZrKibWDtM0Ork4mEYzL1c2Uw/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mDT1JzFPb3gsbShibjMoUfECfmiciaBeibpmQWd3qld9RuKmDo3HA2cuoHtrPKianLB2xODy7cOIcoNKLg/640?wx_fmt=jpeg&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/jqTxnpIZ2mDT1JzFPb3gsbShibjMoUfECXlBOW2hFxl6s0AaRDkgM19ib9iaeVhu8clGmdzUTRztfKNGAnhThFiaPw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mDT1JzFPb3gsbShibjMoUfEC93PKT6PwtKnHkEd3Picz3SxjibqKuicxF4NHB61XRTZl6K1IGWpEzbzCQ/640?wx_fmt=jpeg&from=appmsg)

## 未来规划

为了进一步推动 openEuler RISC-V 生态建设发展，稳固 openEuler RISC-V 作为全栈应用的系统底座，RISC-V SIG 计划将在下面几个方向继续投入：

1. 基于 openEuler 24.03 版本的适配工作，为各种软件栈提供可靠的流水线测试，与手工验证。
2. 探索openEuler 在 RISC-V 上的最优应用生态，进一步拓展 openEuler RISC-V 的落地场景。
3. 基于系统的维度，RISC-V SIG 对 openEuler RISC-V 不断进行软件优化与硬件优化，打造可靠的全栈场景 RISC-V 系统基座。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/jqTxnpIZ2mDT1JzFPb3gsbShibjMoUfEC595mJmVUz1cLlVpAicJEFw7mmSicYVSgml2toe1u9oiawJAaLMpNwoGNQ/640?wx_fmt=jpeg&from=appmsg)

**添加请备注 OERV**

**RISC-V SIG 主页**

https://www.openeuler.org/zh/sig/sig-detail/?name=sig-RISC-V
