# [新突破！openEuler UniProton 实时操作系统成功适配 RISC-V 架构](https://mp.weixin.qq.com/s/Kdxad_DSHdhhOpzB44DxWw)

[OpenAtom openEuler](javascript:void%280%29;)*2024-02-07 20:19:08*
...
![](https://mmbiz.qpic.cn/mmbiz_png/A0h5yD51CMaQSz67b1evO9X334BFrTRUUdEmeseFY334SnA3DiaYSZccRYwubagicMhC4jiagz4ueqwKdBF6p1hIg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMaQSz67b1evO9X334BFrTRUj0ico0YNpsG4G2Pr9v72iciat8tpehWL8xbTZv7JeSSjoTTz5wXfDucUA/640?wx_fmt=jpeg&from=appmsg)

在上述能力的支持下，开发者可以利用中断系列的 API 开发 RISC-V 芯片的设备驱动程序；利用异常系列的 API 开发 RISC-V 下的 Dump 工具作为内核开发的辅助调试工具，如打印出异常相关的 RISC-V 寄存器值和异常原因，利用回调处理特殊的 RISC-V 异常，并且结合 RISC-V MMU 实现 lazy\_brk, cow 等类似的特性；利用进程 API 结合其他系列的 API 开发 RISC-V 架构设备驱动，开发基础组件如自定义 shell，自定义协议栈等；利用其他用户 API 如 CPU 占用率 API，钩子模块 API 等开发性能测试工具
...
- RISCV64\_QEMU\_HelloWorld 工程：https://gitee.com/openeuler/UniProton/blob/master/doc/demoUsageGuide/riscv64\_demo\_usage\_guide.md
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/A0h5yD51CMaQSz67b1evO9X334BFrTRUZ3GBE8XaWwtaGD1Q5YbkKQMTAKVnyGxfuZ4icWK7y6X5kj5MAQT2gUw/640?wx_fmt=jpeg&from=appmsg)
